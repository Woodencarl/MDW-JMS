...
public class OrderProcessorConsumer implements MessageListener {
	...
	public void onMessage(Message msg) {
		String queueNewTrips = "jms/mdw-newtrips";
		String queueBooking = "jms/mdw-booking";
		...
		try {
			...
			if (msgText.equals("booking")) {
				...
				producer.send(queueBooking, msgText);
				System.out.println("Message produced: " + msgText);
			}
			if (msgText.equals("new trip")) {
				OrderClient producer = new OrderClient();
				producer.send(queueNewTrips, msgText);
				System.out.println("Message produced: " + msgText);
			}
