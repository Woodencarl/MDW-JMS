...
import jms.OrderProcessorConsumer;
...
public class OrderProcessor {
	...
	public void send(String queueName, String message) throws Exception {
		...
		// create a JNDI context to lookup JNDI objects (connection factory and
		// queue)
		...
		try {
			...
			System.out.println("The message was sent to the destination " + qsender.getDestination().toString());
		} finally {
			close();
		}
	}
	...
	public static void main(String[] args) throws Exception {
		String allorderqueue = "jms/mdw-allorder";
		OrderProcessorConsumer consumer = new OrderProcessorConsumer();
		consumer.receive(allorderqueue);
	}
