...
public class OrderClient {
    ...
    // connection factory
        ...
        public void init(Context ctx, String queueName)
            ...
            allTripQueue = (Queue) ctx.lookup(queueName);
            
            // create sender and message
            qsender = qsession.createSender((javax.jms.Queue) allTripQueue);
        ...
        public static void main(String[] args) throws Exception {
            // input arguments
            String queueName = "jms/mdw-allorder" ;
            ...
            producer.send(queueName, "new trip");
            System.in.read();
            producer.send(queueName, "booking");
            System.in.read();
            producer.send(queueName, "new trip");
